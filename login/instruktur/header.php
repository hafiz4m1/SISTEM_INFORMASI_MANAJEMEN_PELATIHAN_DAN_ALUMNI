...
if (!isset($_SESSION['logged_in']) || $_SESSION['level'] !== 'instruktur') {
    header("location: ../login.php?pesan=Anda harus login sebagai instruktur.");
    exit;
}
...
<head>
  ...
  <title><?= $page_title ?? 'Instruktur' ?> | Aplikasi Monitoring Alumni &amp; Pelatih</title>
...
<div id="main">
  <div id="topbar">
    ...
    <div style="font-size:13px;color:#6b7280">
      ...
      &nbsp;·&nbsp; <span class="badge bg-purple" style="font-size:11px;background:#6a3090">Instruktur</span>
    </div>
  </div>
