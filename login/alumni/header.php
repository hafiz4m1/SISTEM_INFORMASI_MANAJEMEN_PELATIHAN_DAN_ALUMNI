...
if (!isset($_SESSION['logged_in']) || $_SESSION['level'] !== 'alumni') {
    header("location: ../login.php?pesan=Anda harus login sebagai alumni.");
    exit;
}
...
<div id="sidebar">
  ...
  <a href="riwayat_pelatihan.php" class="nav-link <?= $current==='riwayat_pelatihan.php'?'active':'' ?>"><i class="bi bi-clock-history"></i> Riwayat Pelatihan</a>
  <a href="rktl.php" class="nav-link <?= $current==='rktl.php'?'active':'' ?>"><i class="bi bi-clipboard2-check"></i> RKTL Saya</a>
...
<div id="main">
  <div id="topbar">
    ...
    <div style="font-size:13px;color:#6b7280">
      ...
      &nbsp;·&nbsp; <span class="badge bg-success" style="font-size:11px">Alumni</span>
    </div>
  </div>
