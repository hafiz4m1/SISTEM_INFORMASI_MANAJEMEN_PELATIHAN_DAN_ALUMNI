    ...
    <form method="POST">
      <div class="row g-3">
        ...
        <div class="col-md-4">
          ...
          <input type="date" name="tanggal_mulai" class="form-control" value="<?= htmlspecialchars($_POST['tanggal_mulai'] ?? '') ?>" required>
        </div>
        <div class="col-md-4">
          <label class="form-label fw-semibold">Tanggal Selesai <span class="text-danger">*</span></label>
          <input type="date" name="tanggal_selesai" class="form-control" value="<?= htmlspecialchars($_POST['tanggal_selesai'] ?? '') ?>" required>
        </div>
        <div class="col-md-4">
          <label class="form-label fw-semibold">Kuota Peserta <span class="text-danger">*</span></label>
          <input type="number" name="kuota" class="form-control" value="<?= (int)($_POST['kuota'] ?? 30) ?>" min="1" required>
        </div>
        <div class="col-md-6">
